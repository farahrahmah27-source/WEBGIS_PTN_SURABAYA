...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [682747.560329, 9187656.528720, 699581.639365, 9198357.077872], maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:32749',
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">WebGIS_PTN_Surabaya</h2>';
        return titleElement;
    })(),
